...
function enable_fkt(key){
    switch (key) {
        case "top-panel":
            ...
            break;
        case "dash":
            Main.overview._overview._controls._dashFader._dash.add_style_class_name('shell-transparency');
            break;
        case "search":
...
function disable_fkt(key){
    switch (key) {
        case "top-panel":
            ...
            break;
        case "dash":
            Main.overview._overview._controls._dashFader._dash.remove_style_class_name('shell-transparency');
            break;
        case "search":
